...
export default class CPQ_AdminApprovalCriteriaGroupForm extends LightningElement {
                ...
                'childsaved', {
                    detail: {
                        ...
                        selected: {
                            ...
                            approvalCriteriaGroup: undefined,
                            approvalCriteriaGroupName: undefined,
                            approvalCriteriaGroupTab: undefined
                        }
                    }
                }
            );
        ...
        const savedEvent = new CustomEvent(
            'childsaved', {
                detail: {
                    toast: {
                        title: 'Success!',
                        message: 'Approval Criteria Group was saved',
                        variant: 'success'
                    },
                    selected: {
                        playbook: this.selected.playbook,
                        ...
                        approvalName: this.selected.approvalName,
                        approvalTab: 'criteriaGroups',
                        approvalCriteriaGroup: event.detail.id,
    ...
    async cloneGroup() {
        ...
        try {
            let newRecord = await cloneRecord({
                ...
                objectAPI: 'CPQ_Playbook_Approval_Criteria_Group__c'
            });
                ...
                'childsaved', {
                    detail: {
                        ...
                        selected: {
                            ...
                            approvalName: this.selected.approvalName,
                            approvalTab: 'criteriaGroups',
                            approvalCriteriaGroup: newRecord.Id,
                            approvalCriteriaGroupName: newRecord.Name,
                            approvalCriteriaGroupTab: 'group'
                        }
                    }
                }
