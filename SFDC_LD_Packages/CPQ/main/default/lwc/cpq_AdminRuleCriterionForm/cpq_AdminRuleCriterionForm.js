...
export default class CPQ_AdminRuleCriterionForm extends LightningElement {
    ...
    get groupId() {
        return this.selected.ruleCriteriaGroup.split('-')[0];
    }
                ...
                'childsaved', {
                    detail: {
                        ...
                        selected: {
                            ...
                            ruleCriteriaGroupCriterion: undefined,
                            ruleCriteriaGroupCriterionName: undefined
                        }
                    }
                }
            );
            ...
            'childsaved', {
                detail: {
                    ...
                    selected: {
                        ...
                        ruleCriteriaGroupName: this.selected.ruleCriteriaGroupName,
                        ruleCriteriaGroupTab: 'criteria',
                        ruleCriteriaGroupCriterion: event.detail.id
                    }
                }
            });
    ...
    async cloneCriterion() {
        ...
        try {
            let newRecord = await cloneRecord({
                ...
                objectAPI: 'CPQ_Playbook_Rule_Criterion__c'
            });
                ...
                'childsaved', {
                    detail: {
                        ...
                        selected: {
                            ...
                            ruleCriteriaGroupName: this.selected.ruleCriteriaGroupName,
                            ruleCriteriaGroupTab: 'criteria',
                            ruleCriteriaGroupCriterion: newRecord.Id,
                            ruleCriteriaGroupCriterionName: newRecord.Name,
                        }
                    }
                }
            );
