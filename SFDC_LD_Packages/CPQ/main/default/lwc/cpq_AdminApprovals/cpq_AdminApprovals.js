...
export default class CPQ_AdminApprovals extends LightningElement {

    // All approvals for playbook
    @api approvals;

    // Object containing selections for all levels
    @api selected;

    // Create new approval toggle
            ...
            'select', {
                detail: {
                    selected: {
                        ...
                        approval: event.detail.item.approvalInfo.Id,
                        approvalName: event.detail.item.approvalInfo.Name,
