...
export default class CPQ_AdminRuleCriteriaGroupForm extends LightningElement {
                ...
                'childsaved', {
                    detail: {
                        ...
                        selected: {
                            ...
                            ruleCriteriaGroup: undefined,
                            ruleCriteriaGroupName: undefined,
                            ruleCriteriaGroupTab: undefined
                        }
                    }
                }
            );
        ...
        const savedEvent = new CustomEvent(
            'childsaved', {
                detail: {
                    toast: {
                        title: 'Success!',
                        message: 'Criteria Group was saved',
                        variant: 'success'
                    },
                    selected: {
                        playbook: this.selected.playbook,
                        ...
                        ruleName: this.selected.ruleName,
                        ruleTab: 'criteriaGroups',
                        ruleCriteriaGroup: event.detail.id,
    ...
    async cloneGroup() {
        ...
        try {
            let newRecord = await cloneRecord({
                ...
                objectAPI: 'CPQ_Playbook_Rule_Criteria_Group__c'
            });
                ...
                'childsaved', {
                    detail: {
                        ...
                        selected: {
                            ...
                            ruleName: this.selected.ruleName,
                            ruleTab: 'criteriaGroups',
                            ruleCriteriaGroup: newRecord.Id,
                            ruleCriteriaGroupName: newRecord.Name,
                            ruleCriteriaGroupTab: 'group'
                        }
                    }
                }
