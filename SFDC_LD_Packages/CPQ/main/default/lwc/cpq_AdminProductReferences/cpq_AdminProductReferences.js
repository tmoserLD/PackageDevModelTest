...
export default class CPQ_AdminProductReferences extends LightningElement {
    ...
    get isSelected() {
        return this.selected.productTab !== 'references';
    }
        ...
        'select', {
            detail: {
                selected: {
                    ...
                    productTab: this.selected.productTab === 'references' ? 'product' : 'references'
                }
            }
        });
