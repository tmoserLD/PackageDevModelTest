...
export default class CPQ_QuoteEntitlement extends LightningElement {
    ...
    get colCSS() {
        ...
        if (this.columnsToDisplay.length > 5) {
            ...
            colCSS += ' slds-size_1-of-5';
        }
        else if (this.columnsToDisplay.length === 4) {
            colCSS += ' slds-size_1-of-4';
        }
        else if (this.columnsToDisplay.length === 3) {
            colCSS += ' slds-size_1-of-3';
        }
        else if (this.columnsToDisplay.length === 2) {
            colCSS += ' slds-size_1-of-2';
        }
        else if (this.columnsToDisplay.length === 1) {
            colCSS += ' slds-size_1-of-1';
        }
        return colCSS;
    }
